...
## Trigger third-service quota
Scheduled using QUOTA_REPORT_SCHEDULE environment variable
Manual trigger
```` shell script
scalingo run --region osc-fr1 --app pix-bot --size M "node -e \"require('./lib/services/sendinblue-report').getReport()\""
```` 
